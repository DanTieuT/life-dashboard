...
// Shared read/write dashboard logic — see dashboard-lib.js. Also consumed by
// dashboard-context.js / dashboard-actions.js (the ChatGPT bridge).
const {
  uidGen, todayStr, isRDO, buildContext, ptToEpoch, findById, applyActions,
  runCalendarSideEffects,
} = require('./dashboard-lib.js');
